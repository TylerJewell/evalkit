 ...
 *
 * <p>A scorer signals absence two ways. It can return {@link RunOutcome.Inconclusive}, which
 ...
 * in this kit and becomes {@link RunOutcome.Failed}. Both arrive as a throw, so the
 ...
 */
public class InconclusiveScore extends RuntimeException {

    private static final long serialVersionUID = 1L;

    public InconclusiveScore(String reason) {
        super(reason);
    }

    public InconclusiveScore(String reason, Throwable cause) {
        super(reason, cause);
    }
}
